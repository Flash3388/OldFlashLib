 ...
 * @author Tom Tzook
 */
public class XboxController extends Sendable implements HID, ScheduledTask{
	
	private static DriverStation ds = DriverStation.getInstance();
	private int channel;
	private Button[] buttons = new Button[10];
	private String[] buttonNames = {("A"),("B"),("X"),("Y"),("LB"),("RB"),("Back"),("Start"),("LStick"),("RStick")};
	...
	public boolean getRawButton(int button){
		return ds.getStickButton(channel, (byte)button);
	}
	@Override
