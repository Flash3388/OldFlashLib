...
public class VisionShift extends Action implements VisionAction{
	...
	private int lastDir, margin;
	private long timeout, timeLost, centeredTimeout, timeCentered;
	
	public VisionShift(XAxisMovable driveTrain, Vision vision, double speed, boolean horizontal, int margin, long timeout, long centeredTime){
		this.vision = vision;
