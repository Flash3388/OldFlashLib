...
public class PDP extends Sendable{
	...
	private static class PDPSendableData implements SendableData{
	...
	private PDPSendableData data = new PDPSendableData();
	...
	public void newData(byte[] data) {
		...
		if(data[0] == 1)
			this.data.setMinSend();
		else if(data[0] == 2)
			this.data.setMaxSend();
		else this.data.stopSend();
	}
	@Override
