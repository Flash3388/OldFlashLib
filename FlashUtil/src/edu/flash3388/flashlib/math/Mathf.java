...
public class Mathf {
	...
	public static final int DEFAULT_INTEGRAL_TREPAZOIDS = 100;
	public static final int DEFAULT_INTEGRAL_SLICES = 10;
	public static final double DERIVATIVE_CHANGE_CONSTANT = 1e-8;
	public static final double ROOT_DIFFERENCE = 1e-8;
	public static final int FOURIER_SAMPLES = 100;
	...
	public static double angleFromChord(double chordLength, double radius){
		return  (2 * Math.atan(chordLength / (2 * radius)) * TO_DEGREES);
	}
	...
	public static double forwardDifference(Function func, double x){
		return forwardDifference(func, x, DERIVATIVE_CHANGE_CONSTANT);
	}
	...
	public static double backwardDifference(Function func, double x){
		return backwardDifference(func, x, DERIVATIVE_CHANGE_CONSTANT);
	}
	...
	public static double centralDifference(Function func, double x){
		return centralDifference(func, x, DERIVATIVE_CHANGE_CONSTANT);
	}
	...
	public static double centralDifference2(Function func, double x){
		return centralDifference2(func, x, DERIVATIVE_CHANGE_CONSTANT);
	}
	...
	public static double getInclination(double z, double magnitude){
		double angle = (Math.acos(z / magnitude) * TO_DEGREES); 
	...
	public static double getX(double magnitude, double azimuth, double inclination){
		return (magnitude * Math.sin(inclination * TO_RADIANS) * Math.cos(azimuth * TO_RADIANS));
	}
	public static double getX(double magnitude, double azimuth){
		return (magnitude * Math.cos(azimuth * TO_RADIANS));
	}
	public static double getY(double magnitude, double azimuth, double inclination){
		return (magnitude * Math.sin(inclination * TO_RADIANS) * Math.sin(azimuth * TO_RADIANS));
	}
	public static double getY(double magnitude, double azimuth){
		return (magnitude * Math.sin(azimuth * TO_RADIANS));
	}
	public static double getZ(double magnitude, double inclination){
		return (magnitude * Math.cos(inclination * Mathf.TO_RADIANS));
	}
}
