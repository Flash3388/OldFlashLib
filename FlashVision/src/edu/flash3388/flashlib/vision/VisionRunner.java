...
public abstract class VisionRunner extends Sendable implements Vision{
	...
	private static class RunnerSendableData implements SendableData{
		private Vision vision;
		
		public RunnerSendableData(Vision v){
			this.vision = v;
		}
		
		@Override
		public byte[] get() {
			return vision.getAnalysis().transmit();
		}
		@Override
		public boolean hasChanged() {
			return vision.hasNewAnalysis();
		}
		@Override
